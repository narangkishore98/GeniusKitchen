     ...
     <body style="background-color: #F4F4F4;">
        ...
        <div class="container-fluid" align="center">
                ...
                %>
                    ...
                    <h2 align="center" style="font-family: Brush Script MT, cursive;font-size: 60px;color: darkred;"> Checking out through PayPal  </h2>
...
<!--                        copy-->
                    ...
                    <table align="center">
                        <tr>
                            <td><input type="submit" value="Checkout using Paypal" class="btn btn-primary"/></td>
                    </tr>
                    </table>
                </form><br/><br/>
            </div>
