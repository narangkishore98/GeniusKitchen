...
<html>
    ...
    <body style="background-color: #F4F4F4;" class="text-dark">
       <jsp:include page="new_header.jsp"/>
        <div class="container-fluid" align="center">
                <h2 class="headings" align="center">Restaurant Login</h2>
                <br>
         <form action="restaurantlogin2.jsp" id="form" method="post">
            <table>
                <tr>
                    <td>Username</td>
                    <td><input type="text" name="username" placeholder="Enter Username" id="username" required/></td>
                </tr>
                <tr>
                    <td>Password</td>
