...
<html>
    ...
    <body style="background-color: #F4F4F4;">
        ...
        <div class="container-fluid">
            <br/>
                <h1 style="font-family: Brush Script MT, cursive;font-size: 50px;color: darkred;" align="center">Pending Restaurant Information</h1>
                <br>
                <br>
         <%@page import="java.sql.*" %>
       ...
       %>
            ...
            while(rs.next())
            {
                ...
                <tr>
                    ...
                    <td><br/><a href="approve_restaurant.jsp?q=<%=rs.getString("username")%>" onclick="return go()" class="btn btn-success">Approve</a></td>
                </tr>
                <%}
                }%>
                 </table>
